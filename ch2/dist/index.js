...
function booleanEx() {
    ...
    const c = true;
    let d = true;
    let e = true; // 型別字面值：type literal（僅代表單一值的型別）
    // let f: true = false
}
function numberEx() {
    let a = 1234;
...
function objectEx() {
    ...
    class Person {
        firstName;
        lastName;
        constructor(firstName, // public是this.firstName = firstName的簡寫
        lastName) {
...
function tuple() {
    ...
    let trainFares = [[3.75], [8.25, 7.70], [10.50]];
    // 等效於
    let moreTrainFares = [[2.22]];
    // 其餘元素 rest elements 
...
function enums() {
    ...
    (function (Language) {
        Language[Language["English2"] = 0] = "English2";
        Language[Language["Spanish2"] = 1] = "Spanish2";
        Language[Language["Russian2"] = 2] = "Russian2";
    })(Language || (Language = {}));
    // 取值的方式
    let myFirstLanguage = Language.Russian;
    let mySecondLanguage = Language['English'];
    (function (Language) {
        Language[Language["English3"] = 100] = "English3";
        Language[Language["Spanish3"] = 500] = "Spanish3";
        Language[Language["Russian3"] = 501] = "Russian3"; // (enum member) Language.Russian3 = 501 (typescript推論出)
    })(Language || (Language = {}));
    // 使用字串，或混合字串與數值
    let Color;
    (function (Color) {
